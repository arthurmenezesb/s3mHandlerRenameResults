...
public abstract class GCParser {
    ...
    public static SearchResult searchByCoords(@NonNull final Geopoint coords, final CacheType cacheType, final boolean showCaptcha, final RecaptchaReceiver recaptchaReceiver) {
    ...
    public static SearchResult searchByKeyword(@NonNull final String keyword, final CacheType cacheType, final boolean showCaptcha, final RecaptchaReceiver recaptchaReceiver) {
            ...
            public void call(final Subscriber<? super LogEntry> subscriber) {
                ...
                try {
                    ...
                    for (final JsonNode entry : data) {
                        ...
                        } catch (ParseExceptionNullPointerException |  e) {

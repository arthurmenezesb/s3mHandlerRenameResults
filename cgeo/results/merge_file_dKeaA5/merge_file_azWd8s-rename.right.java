...
public class cgeoapplication extends Application {
    ...
    private final HashMap<Long, cgSearch> searches = new HashMap<Long, cgSearch>();

    // information about searches
    private final HashMap<String, cgCache> cachesCache = new HashMap<String, cgCache>();
    ...
    public boolean addCacheToSearch(cgSearch search, cgCache cache) {
        ...
        storage.isThere(geocode, guid, false, false) == false || cache.reason >= 1) {

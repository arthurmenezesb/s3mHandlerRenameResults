...
public class Settings {
    ...
    public static final boolean HW_ACCEL_DISABLED_BY_DEFAULT = Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR1 || // HTC One X
    StringUtils.equals(Build.MODEL, "HTC One X") || // HTC One S
    StringUtils.equals(Build.MODEL, "HTC One S") || // Samsung S3 mini
    StringUtils.equals(Build.MODEL, "GT-I8190") || // Samsung Galaxy Young
    StringUtils.equals(Build.MODEL, "GT-S6310L") || // Samsung Galaxy Tab 3
    StringUtils.equals(Build.MODEL, "GT-P5210") || // Samsung Galaxy Trend Plus
    StringUtils.equals(Build.MODEL, "GT-S7580") || // Samsung Galaxy SII Plus
    StringUtils.equals(Build.MODEL, "GT-I9105P") || // Sony Xperia U
    StringUtils.equals(Build.MODEL, "ST25i") || // bq Aquaris 5
    StringUtils.equals(Build.MODEL, "bq Aquaris 5") || // Unknown A1-810
    StringUtils.equals(Build.MODEL, "A1-810") || // Samsung S4 mini
    StringUtils.equals(Build.MODEL, "GT-I9195") || StringUtils.equals(Build.MODEL, "GT-I8200N");

    // Samsung S3 mini
    // twitter api keys
    @NonNull
    private static final String TWITTER_KEY_CONSUMER_PUBLIC = CryptUtils.rot13("ESnsCvAv3kEupF1GCR3jGj");

    @NonNull
    private static final String TWITTER_KEY_CONSUMER_SECRET = CryptUtils.rot13("7vQWceACV9umEjJucmlpFe9FCMZSeqIqfkQ2BnhV9x");
     ...
     * @return a pair either with (login, password) or (empty, empty) if no valid information is stored
     */
    public static ImmutablePair<String, String> getCredentials(@NonNull final ICredentials connector) {
    ...
    public static boolean isGCPremiumMember() {
        ...
        return StringUtils.equalsIgnoreCase(memberStatus, GCConstants.MEMBER_STATUS_PREMIUM) || StringUtils.equalsIgnoreCase(memberStatus, GCConstants.MEMBER_STATUS_CHARTER);
    }
    ...
    public static boolean hasOCAuthorization(final int tokenPublicPrefKeyId, final int tokenSecretPrefKeyId) {
        return StringUtils.isNotBlank(getString(tokenPublicPrefKeyId, "")) && StringUtils.isNotBlank(getString(tokenSecretPrefKeyId, ""));
    }
    ...
    public static boolean useGooglePlayServices() {
        ...
        return CgeoApplication.getInstance().isGooglePlayServicesAvailable() && getBoolean(R.string.pref_googleplayservices, VERSION.SDK_INT >= VERSION_CODES.ICE_CREAM_SANDWICH);
    }
    ...
    private static boolean useImperialUnitsByDefault() {
        ...
        return // USA
        "US".equals(countryCode) || // Liberia
        "LR".equals(countryCode) || // Burma
    ...
    public static GeoPointImpl getMapCenter() {
        return getMapProvider().getMapItemFactory().getGeoPointBase(new Geopoint(getInt(R.string.pref_lastmaplat, 0) / 1e6, getInt(R.string.pref_lastmaplon, 0) / 1e6));
    }
    ...
    public static void setTwitterTokens(@Nullable final String tokenPublic, @Nullable final String tokenSecret, final boolean enableTwitter) {
    ...
    public static void setTwitterTempTokens(@Nullable final String tokenPublic, @Nullable final String tokenSecret) {
    ...
    public static int getDefaultNavigationTool() {
        return Integer.parseInt(getString(R.string.pref_defaultNavigationTool, String.valueOf(NavigationAppsEnum.COMPASS.id)));
    }

    public static int getDefaultNavigationTool2() {
        return Integer.parseInt(getString(R.string.pref_defaultNavigationTool2, String.valueOf(NavigationAppsEnum.INTERNAL_MAP.id)));
    }

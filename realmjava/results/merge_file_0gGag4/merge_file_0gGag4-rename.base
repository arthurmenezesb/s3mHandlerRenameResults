...
public class RealmObjectTests {
    ...
    private enum Method {
        ...
        METHOD_GETTER(), METHOD_SETTER(), METHOD_DELETE_FROM_REALM()
    }
    ...
    public void classNameConflictsWithFrameworkClass() {
        ...
        realm.beginTransaction();
        @SuppressWarnings("unused") io.realm.entities.Thread thread = realm.createObject(io.realm.entities.Thread.class);
        realm.commitTransaction();
    }
    ...
    public void addChangeListener_shouldAddTheObjectToHandlerRealmObjects() {
        ...
        realm.commitTransaction();
        final ConcurrentHashMap<WeakReference<RealmObjectProxy>, Object> realmObjects = realm.handlerController.realmObjects;

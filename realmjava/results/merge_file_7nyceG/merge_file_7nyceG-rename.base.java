...
public class BooleansRealmProxy extends Booleans {
    ...
    public static void populateUsingJsonObject(Booleans obj, JSONObject json) throws JSONException {
    ...
    public static void populateUsingJsonStream(Booleans obj, JsonReader reader) throws IOException {
        boolean standalone = obj.realm == null;
        reader.beginObject();

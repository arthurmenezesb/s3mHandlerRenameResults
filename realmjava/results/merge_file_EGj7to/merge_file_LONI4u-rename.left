...
public class BooleansRealmProxy extends Booleans implements RealmObjectProxy, BooleansRealmProxyInterface {
    ...
    @SuppressWarnings("cast")
    public static Booleans createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
    ...
    @SuppressWarnings("cast")
    public static Booleans createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        Booleans obj = realm.createObject(Booleans.class);
        reader.beginObject();

...
public abstract class ColumnInfo {
    ...
    protected final long addColumnDetails(Table table, String columnName, RealmFieldType columnType) {
        ...
        if (columnIndex >= 0) {
            String linkedTableName = ((columnType != RealmFieldType.OBJECT) && (columnType != RealmFieldType.LIST)) ? null : table.getLinkTarget(columnIndex).getClassName();
    ...
    public //@VisibleForTesting(otherwise = VisibleForTesting.NONE)
    Map<String, ColumnDetails> getIndicesMap() {
        return indicesMap;
    }
}

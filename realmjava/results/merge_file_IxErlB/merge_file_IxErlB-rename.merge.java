...
public class SimpleRealmProxy extends Simple implements RealmObjectProxy {
    ...
    public static void populateUsingJsonObject(Simple obj, JSONObject json) throws JSONException {
    ...
    public static void populateUsingJsonStream(Simple obj, JsonReader reader) throws IOException {
        boolean standalone = obj.realm == null;
        reader.beginObject();

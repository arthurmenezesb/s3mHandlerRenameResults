...
public class SimpleRealmProxy extends Simple implements RealmObjectProxy {
    ...
    public static Simple createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update) throws JSONException {
    ...
    public static Simple createUsingJsonStream(Realm realm, JsonReader reader) throws IOException {
        Simple obj = realm.createObject(Simple.class);
        reader.beginObject();
    ...
    public boolean equals(Object o) {
        ...
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null)
            return false;
        if (row.getIndex() != aSimple.row.getIndex())
            return false;
        return true;
    }
}

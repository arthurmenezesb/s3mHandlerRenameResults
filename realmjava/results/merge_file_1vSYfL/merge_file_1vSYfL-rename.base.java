...
public class RealmQuery<E extends RealmObject> {
    ...
    private long[] getColumnIndices(String fieldName, ColumnType fieldType) {
        ...
        if (containsDot(fieldName)) {
            ...
            if (fieldType != tableColumnType) {
                throw new IllegalArgumentException(String.format("Field '%s': type mismatch. Was %s, expected %s.", fieldName, fieldType, tableColumnType));
            }
     ...
     */
    @Deprecated
    public RealmResults<E> findAll(String fieldName1, boolean sortAscending1, String fieldName2, boolean sortAscending2, String fieldName3, boolean sortAscending3) {
        return findAll(new String[] { fieldName1, fieldName2, fieldName3 }, new boolean[] { sortAscending1, sortAscending2, sortAscending3 });
    }
